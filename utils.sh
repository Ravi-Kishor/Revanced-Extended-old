...
patch_apk() {
	...
	echo "java -jar $RV_CLI_JAR --rip-lib x86 --rip-lib x86_64 --rip-lib armeabi-v7a -c -a $stock_input -o $patched_apk -b $RV_PATCHES_JAR --keystore=ks.keystore $patcher_args"
